...
func (_m *UserService) FindUserByName(_a0 context.Context, _a1 string) (*models.User, error) {
...
func (_m *UserService) NewUser(_a0 string, _a1 string) (*models.User, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *UserService) SaveUser(_a0 context.Context, _a1 *models.User) (string, error) {
	ret := _m.Called(_a0, _a1)
